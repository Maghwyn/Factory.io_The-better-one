    ...
    <div class="modal_lvl_up">
        ...
        <div class="lvl_up_div">
            ...
            <button @click="levelUpModal()" type="button"
                class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 font-medium rounded-lg text-sm px-5 py-2 text-center mr-2 mb-2 mt-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 h-9">Level up</button>
        </div>
    </div>
